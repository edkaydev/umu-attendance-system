    ...
    <div className="mb-4">
      ...
      <div className="relative">
        <input
          ...
          value={value}
          className={`w-full rounded border-[1.5px] bg-surface-1 px-4 py-3 pr-12 text-sm text-[#1A1A1A] placeholder:text-[#94A3B8] focus:border-umu-red focus:outline-none focus:shadow-[0_0_0_3px_rgba(204,0,0,0.12)] ${error ? 'border-danger' : 'border-border'} ${className}`}
          {...rest}
        />
        <button
          type="button"
