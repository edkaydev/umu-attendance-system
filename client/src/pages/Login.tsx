      ...
      <div className="flex min-h-screen flex-col items-center justify-center bg-white p-6">
        ...
        <div className="mt-10 w-full max-w-sm">
          <a
            ...
            className="inline-flex min-h-[52px] w-full items-center justify-center gap-3 rounded border border-border bg-white px-8 py-3 text-body-lg font-medium text-text-primary shadow-sm transition-colors hover:bg-surface-1 focus:outline-none focus:ring-2 focus:ring-umu-red focus:ring-offset-2"
          >
            {/* Official Google G */}
          ...
          <p className="mt-3 text-center text-xs text-text-disabled">
            Use your UMU Google account (@umu.ac.ug or @stud.umu.ac.ug)
          </p>
        </div>
